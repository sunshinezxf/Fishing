...
<head>
    ...
    <script>
        $(function () {
            ...
            $("#location-management").collapse('show');
        });
        ...
        $(document).ready(function () {
            $("#fish-type-list").DataTable({
                ...
                "bServerSide": true,
                "bInfoFiltered": false,
                "sAjaxSource": '${path.concat('/location/overview')}',
                ...
                "aoColumns": [
                    {"sTitle": "经度", "sWidth": "10%", "mData": "longitude"},
                    {"sTitle": "纬度", "sWidth": "10%", "mData": "latitude"},
                    {"sTitle": "微信", "sWidth": "10%", "mData": "wechat"},
                    {
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        <div class="row">
            <div class="col-md-12 col-lg-12">
                <h1><i class="fa fa-home"></i> 地址管理 </h1>
                <ol class="breadcrumb">
                    <li><a href="${path.concat('/dashboard')}">首页</a></li>
                    <li><a data-toggle="collapse" data-parent="#accordion" href="#location-management">地址管理</a>
                    </li>
                    <li class="active">地址概览</li>
                </ol>
            </div>
        </div>
        <div class="row">
