            ...
            $("#fish-man-list").DataTable({
                ...
                "aoColumns": [
                    ...
                    },
                    {
                        ...
                        var url = "${path.concat('/fishman/edit/')}" + full.contractorId;
                        return "<button type='button' class='btn btn-success btn-group-sm control-box' onclick=\"javascript:location.href='" + url + "'\" id='" + full.contractorId + "'>修改</button>";
                    }
                    }
                ],
                "oLanguage": {
        ...
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar" id="accordion" aria-multiselectable="true">
                ...
                <li><a data-toggle="collapse" data-parent="#accordion" href="#fish-man-management"><i
                        class="fa fa-book"></i> 承包管理<span class="sr-only">(current)</span><i
                        class="pull-right fa fa-caret-down"></i></a>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        <div class="row">
            <div class="col-md-12 col-lg-12">
                <h1><i class="fa fa-home"></i> 承包管理 </h1>
                <ol class="breadcrumb">
                    <li><a href="${path.concat('/dashboard')}">首页</a></li>
                    <li><a data-toggle="collapse" data-parent="#accordion" href="#fish-man-management">承包管理</a>
                    </li>
