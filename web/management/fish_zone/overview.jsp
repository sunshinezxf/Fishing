    ...
    <script>
        ...
        $(document).ready(function () {
            $("#fish-zone-list").DataTable({
                ...
                "bServerSide": true,
                "bInfoFiltered": false,
                "sAjaxSource": '${path.concat('/fishzone/overview')}',
                ...
                "aoColumns": [
                    ...
                    {"sTitle": "收费(元/小时)", "sWidth": "10%", "mData": "fishPondFee"},
                    {
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">渔场概览</li>
                </ol>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 col-lg-12">
                <table id="fish-zone-list" class="table table-striped table-bordered" cellspacing="1" width="100%">
                </table>
            </div>
        </div>
    </div>
